...
$lang['db_invalid_connection_str']      = "Impossible de déterminer les paramètres d'accès à la base de données en se basant sur la chaîne de inscription que vous avez fournie.";
...
$lang['db_unable_to_set_charset']       = "Impossible de définir le jeu de caractères de la inscription client : %s";
